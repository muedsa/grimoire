...
import { ExecNode as ExecNodeType } from "@/store/flow";
import { useNodeState } from "@/hook/useNodeState";
import DebugBadge from "./DebugBadge";
import styles from "./ExecNode.module.css";

function ExecNode({ data, selected, id }: NodeProps<ExecNodeType>) {
