...
describe("evaluate — regex builtins", () => {
  describe("regex_test", () => {
    it("returns true when pattern matches", async () => {
      ...
      expect(await evaluateExpression("regex_test(s, '\\\\d+')", ctx)).toBe(
        true,
      );
    });
    ...
    it("returns false for non-string input", async () => {
      ...
      expect(await evaluateExpression("regex_test(n, '\\\\d+')", ctx)).toBe(
        false,
      );
    });
  ...
  describe("regex_match", () => {
    ...
    it("returns null when no match", async () => {
      ...
      expect(await evaluateExpression("regex_match(s, '\\\\d+')", ctx)).toBe(
        null,
      );
    });
    ...
    it("returns null for non-string input", async () => {
      ...
      expect(await evaluateExpression("regex_match(n, '\\\\d+')", ctx)).toBe(
        null,
      );
    });
  });
  ...
  describe("regex_match_all", () => {
    ...
    it("returns empty array when no match", async () => {
      const ctx = new ExecutionContext({ s: "abc" });
      expect(
        await evaluateExpression("regex_match_all(s, '\\\\d+')", ctx),
      ).toEqual([]);
    });
