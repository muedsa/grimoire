 ...
 */
declare function encodeUriComponent(...args: AllowedValue[]): AllowedValue;
/**
 * URI 组件解码 — 将百分号编码的字符串还原
 * 等价于全局 decodeURIComponent
 */
declare function decodeUriComponent(...args: AllowedValue[]): AllowedValue;
/**
 * URI 编码 — 编码完整 URI，保留协议、域名等保留字符（:, /, ?, #, &, = 等不编码）
 * 等价于全局 encodeURI
 */
declare function encodeUri(...args: AllowedValue[]): AllowedValue;
/**
 * URI 解码 — 将 encodeURI 编码的字符串还原
 * 等价于全局 decodeURI
 */
declare function decodeUri(...args: AllowedValue[]): AllowedValue;
/**
 * HTML 实体解码 — 将 HTML 实体（&#x6DE1; / &#28129; / &amp; 等）还原为原始字符
 * 基于 he 库，支持所有 HTML5 命名实体、十进制/十六进制数字引用
 */
declare function htmlEntityDecode(...args: AllowedValue[]): AllowedValue;
/**
 * HTML 实体编码 — 将字符串中需要转义的字符编码为 HTML 实体
 * 基于 he 库，默认使用十进制数字引用（&#28129; 格式）
 */
declare function htmlEntityEncode(...args: AllowedValue[]): AllowedValue;
/**
 * encoding 模块自定义函数集合
