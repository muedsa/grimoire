...
function DanmakuTextNode({
  ...
  const needsScale = Platform.OS === "web" && Math.abs(scale - 1) > 1e-3;
  const scaledX = useDerivedValue(() => {
    return x.value / scale;
  }, [x, scale]);
  if (needsScale) {
    const effectiveFont = measurer.baseFont;
    return /* @__PURE__ */ jsx(Group, { transform: [{ scale }], children: /* @__PURE__ */ jsx(
      Text,
      {
        x: scaledX,
        y: y / scale,
...
function DanmakuView({
  ...
  return /* @__PURE__ */ jsxs(
    View,
    {
      ...
      children: [
        /* @__PURE__ */ jsx2(Canvas, { style: styles.canvas, pointerEvents: "none", children: measurer && snapshot.items.map((item) => /* @__PURE__ */ jsx2(
          DanmakuTextNode,
          {
            item,
            clock,
