...
__export(react_native_exports, {
  ...
  DanmakuTextNode: () => DanmakuTextNode,
  DanmakuView: () => DanmakuView,
  SkiaTextMeasurer: () => SkiaTextMeasurer,
  useDanmakuController: () => useDanmakuController
});
module.exports = __toCommonJS(react_native_exports);

// src/react-native/DanmakuView.tsx
var import_react_native_skia3 = require("@shopify/react-native-skia");
var import_react = require("react");
var import_react_native3 = require("react-native");
var import_react_native_reanimated2 = require("react-native-reanimated");

// src/react-native/DanmakuTextNode.tsx
...
function DanmakuTextNode({
  item,
  clock,
  opacity,
  measurer
}) {
  const x = (0, import_react_native_reanimated.useDerivedValue)(() => {
    "worklet";
  ...
  const text = item.mergeCount > 1 ? `${item.text} \xD7${item.mergeCount}` : item.text;
  const font = measurer.fontFor(item.fontSize, item.weight);
  const scale = measurer.baseFontSize > 0 ? item.fontSize / measurer.baseFontSize : 1;
  const needsScale = import_react_native.Platform.OS === "web" && Math.abs(scale - 1) > 1e-3;
  const scaledX = (0, import_react_native_reanimated.useDerivedValue)(() => {
    return x.value / scale;
  }, [x, scale]);
  if (needsScale) {
    const effectiveFont = measurer.baseFont;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_native_skia.Group, { transform: [{ scale }], children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_react_native_skia.Text,
      {
        x: scaledX,
        y: y / scale,
        text,
...
var SkiaTextMeasurer = class {
  ...
  fontFor(fontSize, weight) {
    ...
    const font = import_react_native_skia2.Skia.Font(this.typeface, fontSize);
...
function DanmakuView({
  ...
  const clock = (0, import_react_native_reanimated2.useSharedValue)(0);
  const opacity = (0, import_react_native_reanimated2.useSharedValue)(controller.opacity);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    import_react_native3.View,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react_native_skia3.Canvas, { style: styles.canvas, pointerEvents: "none", children: measurer && snapshot.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          DanmakuTextNode,
          {
            item,
            clock,
...
var styles = import_react_native3.StyleSheet.create({
  container: {
    ...import_react_native3.StyleSheet.absoluteFill,
    overflow: "hidden",
    pointerEvents: "none"
  },
  canvas: {
...
// src/react-native/useDanmakuController.ts
...
function useDanmakuController(options) {
  ...
  const [controller] = (0, import_react2.useState)(() => {
    return new DanmakuController({
      ...rest,
      measurer: font ? new SkiaTextMeasurer(font) : void 0
    });
  });
